...
<script src="${pageContext.request.contextPath}/plugins/datatables/js/jquery.dataTables.min.js"></script>
<script src="${pageContext.request.contextPath}/plugins/datatables/js/dataTables.bootstrap4.min.js"></script>
